...
class TestCodeFormat(unittest.TestCase):
    """
    class test pep8 base_model file"""
    def test_pycodestyle(self):
        """
        Test pep8 format
        """
...
class Test_docstrings(unittest.TestCase):
    ...
    def setup_class(self):
        ...
        Return all the members of an object in a list of name and value
        """
        self.obj_members(BaseModel, inspect.isfunction)


class TestBaseModel(unittest.TestCase):
    """Check base model class x"""
    ...
    def test_method_BaseModel(self):
        """chekcing if Basemodel methods"""
        self.assertTrue(hasattr(BaseModel, "__init__"))
        self.assertTrue(hasattr(BaseModel, "save"))
        self.assertTrue(hasattr(BaseModel, "to_dict"))

    def test_init_BaseModel(self):
        """test basetype BaseModel"""
